...
./linuxdeploy-x86_64.AppImage --appdir="${appdir}" -e "${appdir}/usr/bin/chiaki" -d "${appdir}/usr/share/applications/io.github.ForWardTechnologiesLLC.Pylux.desktop" --plugin qt --output appimage
