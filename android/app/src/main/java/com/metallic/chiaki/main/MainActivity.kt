...
import com.metallic.chiaki.common.FeatureFlags
...
class MainActivity : AppCompatActivity()
{
	...
	override fun onCreate(savedInstanceState: Bundle?)
	{
		...
		// REMOTE_PLAY_ONLY: remove these two lines to restore Cloud Play tab (see FeatureFlags.kt)
		binding.cloudPlayButton.isGone = FeatureFlags.REMOTE_PLAY_ONLY
		binding.cloudPlayIcon.isGone = FeatureFlags.REMOTE_PLAY_ONLY
	...
	{
		// REMOTE_PLAY_ONLY: remove the `if (FeatureFlags.REMOTE_PLAY_ONLY) 1 else` prefix to restore Cloud Play (see FeatureFlags.kt)
		override fun getItemCount(): Int = if (FeatureFlags.REMOTE_PLAY_ONLY) 1 else 2
