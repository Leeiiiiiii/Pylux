    ...
    , m_delayTimer(new QTimer(this))
{
    ...
    connect(m_delayTimer, &QTimer::timeout, this, &DonationManager::checkDonationStatusAndShow);
...
void DonationManager::openSupportFromSettings()
{
    ...
    cancelScheduledOffer();
    m_settingsTriggered = true;
    checkDonationStatusAndShow();
}
...
void DonationManager::checkDonationStatusAndShow()
{
#ifdef CHIAKI_IS_MAC_APPSTORE
    if (!m_storeKit)
        return;
    ...
    connect(reply, &QNetworkReply::finished, this, [this, reply]() {
        ...
        onApiResponse(donated);
    });
#endif
}

void DonationManager::onApiResponse(bool donated)
{
    m_donated = donated;
    emit donatedChanged();
