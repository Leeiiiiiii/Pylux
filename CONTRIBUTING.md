...
| Linux (Flatpak) | Flatpak (x86_64 + aarch64) | Flathub (manifest synced to `flathub/io.github.ForWardTechnologiesLLC.Pylux`) |
...
- **Flatpak** — manifest at `scripts/flatpak/io.github.ForWardTechnologiesLLC.Pylux.yml` (see `.github/workflows/deploy-flatpak.yml`)
